...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("🎥 ᴍᴏᴠɪᴇ ᴜᴘᴅᴀᴛᴇs", url="https://t.me/allnewmovieintime")
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='Source Code not available,because this bot is a private')
            ],[
